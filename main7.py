...
def Sair_programa ():
   ...
   if resposta:
       Janela.destroy()
#---------------------------------------------------------------------------------------------
# função para previsualizar na web -----------------------------------------------------------
def previsualizar_web():
    url_str = url.get()
    if not url_str:
    ...
    try:
        ...
        messagebox.showerror('Erro', f'Erro ao previsualizar na web: {str(e)}')
#---------------------------------------------------------------------------------------------
...
def limpar_campos():
    ...
    Limagem.delete("all")
    Lconclusão.configure(text='Seu download ....')
...
def download():
    ...
    # Adicionar mensagem de conclusão após o download
    Lconclusão.configure(text=f'Download concluído com sucesso. Salvo em: {os.path.dirname(file_path)}')        
#-----------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------
# cria o frontend -----------------------------------------------------------------------------
...
Janela.geometry('617x620+100+100')
Janela.resizable(False, False)
Janela.title('Youtube Downloader V1 Dev Joel Portugal © 2024 Versão em Portugues De Portugal')
Janela.iconbitmap('C:\\Users\\HP\\Desktop\\projectos\\programas\\ferramenta V4 Update\\icon1.ico')
#----------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------------
# criar o botão para previsualizar o video ----------------------------------------------------
Bprev = customtkinter.CTkButton(Janela, text='Previsualizar na web', command=previsualizar_web)
Bprev.place(x=10, y=570)
#----------------------------------------------------------------------------------------------
Lconclusão = customtkinter.CTkLabel(Janela, text='Seu download ....', bg_color='Blue')
Lconclusão.place(x=165, y=570)
# iniciar a janela ----------------------------------------------------------------------------
Janela.mainloop()
#----------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------